 ...
 * Beta 1998.2.0.0.4 – basado en el año 1998
 *
 * Playlist sequence:
...
class LiveDiscoveryKids : AppCompatActivity() {
     ...
     * música y cancela los timers pendientes. No se pausa si estamos en un
     * bumper, enseguida o comercial (isInProgramSegment = false en esos casos).
     */
    ...
    override fun onResume() {
        ...
        if (pausedByLifecycle) {
            ...
            videoView.start()
            bgPlayer?.start()
            // Reprogramar screenbug y el próximo corte comercial desde la posición actual
