 ...
 *   - comercial1.mp4 corregido: el video contenía un clip de ya_regresa embebido.
 *   - Intervalo de cortes comerciales aleatorio entre 3 y 9 minutos.
 *
 ...
 *
 *
 * Estrategia de pausa (Release 3.3.1) — DIFERENCIADA POR TIPO DE ÍTEM:
 *   PROGRAMA  → beginProgramSegment() con seekTo en onPrepared al volver.
 ...
 * Commercial scheduling: 1 break per random interval between 3 and 9 minutes of program content.
...
class LiveDiscoveryKids : AppCompatActivity() {
    ...
    companion object {
        ...
        /** Intervalo mínimo entre cortes comerciales (ms). Release 3.3.1. */
        private const val BREAK_INTERVAL_MIN_MS = 3 * 60 * 1_000L   // 3 min

        /** Intervalo máximo entre cortes comerciales (ms). Release 3.3.1. */
    ...
    /**
     * Release 3.3.1 — PAUSA DIFERENCIADA.
     *
    ...
    /**
     * Release 3.3.1 — REANUDACIÓN DIFERENCIADA.
     *
