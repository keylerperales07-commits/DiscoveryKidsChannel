...
class LiveDiscoveryKids : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val BREAK_INTERVAL_MS = 5 * 60 * 1_000L   // 5 min
    ...
    private fun playCommercial(resumeProgramAtMs: Int) {
        ...
        playUri(rawUri(R.raw.comercial1)) {
            // After commercial ends → resume program segment
            // scheduleSegmentLogic will take care of the 20-s screenbug delay
            ...
            Log.d(TAG, "Commercial done – resuming program at ${resumeProgramAtMs}ms")
