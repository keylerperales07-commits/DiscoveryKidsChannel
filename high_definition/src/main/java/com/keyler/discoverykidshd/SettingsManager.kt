 ...
 *
 * RELEASE 2013.6.0.0-HD — ELIMINADO: "Forzar 4:3" (KEY_FORCE_ASPECT_RATIO), agregado
 * en esta misma Preview. El video ya nunca se estira — ver DkVideoView.kt.
 * ELIMINADO también: música de fondo (KEY_BG_MUSIC_ENABLED) y efecto CRT
 * (KEY_CRT_EFFECT_ENABLED, CrtOverlayView.kt eliminado por completo).
 *
...
object SettingsManager {
    ...
    // RELEASE 2013.6.0.0-HD — se eliminó KEY_FORCE_ASPECT_RATIO ("force_aspect_ratio_4_3"):
    // el switch "Forzar 4:3" de Configuración desaparece por completo. Ver
    // nota equivalente en DkVideoView.kt — el video ya nunca se estira,
    // siempre respeta su proporción real dentro del marco 4:3.
