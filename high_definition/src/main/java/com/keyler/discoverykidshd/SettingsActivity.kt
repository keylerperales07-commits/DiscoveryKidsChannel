 ...
 *   - Se agregaron: duración del Screenbug e intervalo de comerciales
 *     (min/max) — ambos abren un diálogo simple al tocarlos.
 *
 ...
 *
 * RELEASE 2013.6.0.0-HD — ELIMINADO por completo: el switch "Forzar 4:3"
 *   (switchForceAspectRatio / itemForceAspectRatio). El video ya nunca se
 *   estira dentro del marco 4:3 — siempre respeta su proporción real. Ver
 *   DkVideoView.kt. También ELIMINADOS por completo: "Música de fondo"
 *   (switchBgMusic / itemBgMusic) y "Efecto CRT" (switchCrtEffect /
 *   itemCrtEffect, CrtOverlayView.kt eliminado del proyecto).
 */
