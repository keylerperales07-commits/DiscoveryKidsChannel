...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Preview-v4.6.0.60-orange?style=flat-square"/>
...
> Cambios ya en pruebas, todavía sin llegar a una versión estable. Se van a marcar como Release recién cuando se confirme que están listos.

### `v4.6.0.60` *(Preview · Era Doki 1.0 · Era 2008)*
> *Segundo rediseño de UpdateActivity: ahora calca la pantalla nativa de Android "Configuración → Sistema → Actualización del sistema" en vez del diseño tipo diálogo centrado del release anterior.*

- 🎨 **`UpdateActivity` rediseñada de nuevo** — ícono, título y subtítulos alineados a la izquierda (antes centrados), barra de progreso fina debajo del título (reemplaza al spinner/barra gruesa), y renglones de lista con flecha ">" en vez de botones — igual que "Comprobar actualizaciones" en Configuración.
- Sin cambios de comportamiento: el flujo de estados y `AppUpdater.kt` quedan igual que en `v4.4.0`.
