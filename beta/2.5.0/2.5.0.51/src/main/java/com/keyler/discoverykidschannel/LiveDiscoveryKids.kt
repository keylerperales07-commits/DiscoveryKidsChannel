 ...
 *   - Las tallas se ubican entre el enseguida post-programa y el bumper:
 ...
 * Enseguidas 1 y 2 (enseguida1.mp4, enseguida2.mp4) aparecen entre post-programa y talla, aleatorios sin repetir.
...
class LiveDiscoveryKids : AppCompatActivity() {
    ...
    // Última talla reproducida (tallas_1/2/3); evita repetir la misma dos veces seguidas
    private var lastTallaRes: Int = -1
    ...
    companion object {
        ...
        /**
         * Tallas disponibles (tallas_1, tallas_2, tallas_3).
         * Se eligen al azar evitando repetir la misma dos veces seguidas,
         * igual que los comerciales y bumpers.
         * Se ubican entre enseguida post-programa y bumper.
         */
        private val TALLAS = listOf(R.raw.tallas_1, R.raw.tallas_2, R.raw.tallas_3)
    ...
    // Usa tallas_1, tallas_2 o tallas_3 (aleatorio, sin repetir la misma dos veces seguidas).
    // La talla elegida determina qué screenbug se mostrará durante el programa siguiente:
    //   tallas_1 → screenbug_small | tallas_2 → screenbug_medium | tallas_3 → screenbug_large
    // ══════════════════════════════════════════════════════════════════════════
    ...
    private fun playTalla() {
        ...
        // Elige talla al azar evitando repetir la anterior
        val candidates = TALLAS.filter { it != lastTallaRes }.ifEmpty { TALLAS }
        val chosenTalla = candidates.random()
        lastTallaRes = chosenTalla

        // Determina el screenbug que se mostrará en el programa siguiente
        currentScreenBugRes = TALLA_SCREENBUG_MAP[chosenTalla] ?: R.drawable.screenbug_small
