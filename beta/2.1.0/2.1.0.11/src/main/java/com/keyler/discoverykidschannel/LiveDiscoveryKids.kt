 ...
 * Beta 1999.2.1.0.11 – basado en el año 1999
 *
 * Restauración de sesión: al cerrar la app completamente y volver a abrirla,
 * se pregunta al usuario si quiere continuar donde estaba (programa, bumper,
 * enseguida o comercial). El estado se guarda en SharedPreferences en onStop.
 *
 * Playlist sequence:
...
class LiveDiscoveryKids : AppCompatActivity() {
    ...
    /**
     * onStop se llama cuando la app deja de ser visible (incluyendo cierre completo).
     * Aquí se guarda el estado en SharedPreferences para que, al volver a abrir,
     * se le pregunte al usuario si quiere continuar donde estaba.
     * Se guarda para bumper, enseguida, programa y comercial.
     */
    override fun onStop() {
        super.onStop()
        saveChannelState()
