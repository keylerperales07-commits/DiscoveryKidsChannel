 ...
 * Beta 1999.2.1.0.12 – basado en el año 1999
 *
 * Restauración de sesión: el estado se guarda SOLO cuando el usuario confirma
 * que quiere salir (onBackPressed → diálogo de confirmación). Esto evita que
 * el AlertDialog de reanudación aparezca al volver de un cambio de app temporal.
 *
 * Playlist sequence:
    ...
    */
    ...
    private fun showExitConfirmationDialog() {
        AlertDialog.Builder(this)
            ...
            .setMessage("¿Querés salir de Discovery Kids Channel?\nSe guardará tu posición actual.")
            .setCancelable(false)
