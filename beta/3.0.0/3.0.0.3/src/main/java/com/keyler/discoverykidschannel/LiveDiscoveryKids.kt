 ...
 * Beta 2002.3.0.0.3
 *
 * Cambios respecto a 3.0.0.2:
 *   - playEnseguida(): eliminada la selección por horario. Ahora es aleatoria
 *     con anti-repetición entre [enseguida1, enseguida2].
 *   - enseguida5 eliminado (ya no existe en res/raw/).
 *   - ENSEGUIDAS_POST_PROGRAMA actualizada: [enseguida1, enseguida2].
 *   - Logo de la app actualizado (cambio externo, sin código).
 *   - enseguida1.mp4 y enseguida2.mp4 actualizados a la Era 2002.
 *
 ...
 * cada tipo de ítem, y cualquier estado intermedio (enseguida3/4, ya_volvemos)
 ...
 *
 * Playlist sequence:
 *   Enseguida(1/2) → Talla(1/2/3) → Bumper → Programa → Enseguida(1/2) → Talla(1/2/3) → Bumper → Programa → ...
 *
...
class LiveDiscoveryKids : AppCompatActivity() {
    ...
    // Funciona para programa, bumper, enseguida, talla, comercial y ya_volvemos.
    ...
    private val playlist = listOf(
        PlayItem.Enseguida,
        PlayItem.StandaloneCommercial,   // Beta 3.0.0.2: comercial entre enseguida y talla
        PlayItem.Bumper,
        PlayItem.Talla,
        PlayItem.Program(0),
        PlayItem.Enseguida,
     ...
     * enseguida, talla, comercial o ya_volvemos).
     *
