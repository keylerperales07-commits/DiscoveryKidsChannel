 ...
 * Beta 1998.2.0.0.2 – basado en el año 1998
 *
 * Playlist sequence:
 *   bumper(aleatorio) → pro1 → bumper(aleatorio) → pro2 → bumper(aleatorio) → pro3 → bumper(aleatorio) → pro4 → bumper(aleatorio)  (then loops)
 *
...
class LiveDiscoveryKids : AppCompatActivity() {
    ...
    companion object {
         ...
         */
        private val BUMPERS = listOf(R.raw.bumper, R.raw.bumper2)
         ...
         */
        private val YA_VOLVEMOS = listOf(R.raw.ya_volvemos, R.raw.ya_volvemos_animalesasombrosos)
    }
