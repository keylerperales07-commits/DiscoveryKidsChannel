...
class LiveDiscoveryKids : AppCompatActivity() {
    ...
    companion object {
        ...
        private val COMMERCIALS = listOf(R.raw.comercial1, R.raw.comercial2)
    }
    ...
    */
    ...
    private fun playCommercial(resumeProgramAtMs: Int) {
        ...
        playUri(rawUri(R.raw.ya_volvemos)) {
            // Elige un comercial al azar de la lista COMMERCIALS
            val randomCommercial = COMMERCIALS.random()
            Log.d(TAG, "▶ COMMERCIAL ${randomCommercial} (resumes program at ${resumeProgramAtMs}ms)")

            playUri(rawUri(randomCommercial)) {
