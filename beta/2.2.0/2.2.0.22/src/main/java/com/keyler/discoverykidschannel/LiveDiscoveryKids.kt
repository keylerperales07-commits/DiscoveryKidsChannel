 ...
 * Beta 1999.2.2.0.23 – basado en el año 1999
 *
...
class LiveDiscoveryKids : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Ajustes del border gradient CRT (1999.2.2.0.23)
        crtOverlay.borderWidth = 80f * resources.displayMetrics.density   // más ancho
        crtOverlay.borderAlpha = 200                                       // más oscuro
